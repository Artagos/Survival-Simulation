...
class Simulation:
    def __init__(self, environment, agents):
        ...
        self.desire_action=  { 
            ...
            'Comunicar sed':lambda x,y,env: self.environment.add_to_context(Belief('Sed','comunication',x.position)),
            'Comunicar hambre':lambda x,y,env: self.environment.add_to_context(Belief('Hambre','comunication',x.position))
            }
    ...
    def step(self):
        ...
        for agent in self.agents:
            ...
            agent.perceive(self.environment.map)
            agent.execute_rules()
